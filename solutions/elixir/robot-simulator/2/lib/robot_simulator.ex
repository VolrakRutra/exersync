defmodule RobotSimulator do
  ...
  defguardp is_direction(direction) when direction == :north
    or direction == :south
    or direction == :east
    or direction == :west

  defguardp is_position(position) when is_tuple(position)
  ...
  def simulate(robot, instructions) do
    commands = instructions |> String.codepoints |> Enum.map(&command_to_func/1)
